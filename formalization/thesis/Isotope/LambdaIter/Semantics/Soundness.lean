...
theorem sound (e : Eqv (τ := τ) (ν := ν) (Φ := Φ) (ε := ε)
  ...
  | op h ih =>
      have ih' :
          Subtyping.Semantics.Categorical.denote J M h.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M h.rightTyping.toGeneric := ih
      calc
        ...
        _ = denote J M (.op h.rightTyping) := by
          simpa only [denote, HasType.toGeneric,
            Subtyping.Semantics.Categorical.denote] using congrArg
            (fun q => q ≫ Subtyping.Semantics.Categorical.InstructionModel.denote _) ih'
        _ = _ := TypingCoherent.denote_eq _ _
  | let₁ ha hb iha ihb =>
      have iha' :
          Subtyping.Semantics.Categorical.denote J M ha.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M ha.rightTyping.toGeneric := iha
      have ihb' :
          Subtyping.Semantics.Categorical.denote J M hb.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M hb.rightTyping.toGeneric := ihb
      calc
        ...
        _ = denote J M (.let₁ ha.rightTyping hb.rightTyping) := by
          simp only [denote, HasType.toGeneric, Subtyping.Semantics.Categorical.denote]
          rw [iha', ihb']
        _ = _ := TypingCoherent.denote_eq _ _
  | unit => rfl
  | pair ha hb iha ihb =>
  ...
  | let₂ he hc ihe ihc =>
      have ihe' :
          Subtyping.Semantics.Categorical.denote J M he.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M he.rightTyping.toGeneric := ihe
      have ihc' :
          Subtyping.Semantics.Categorical.denote J M hc.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M hc.rightTyping.toGeneric := ihc
      calc
  ...
  | case he hl hr ihe ihl ihr =>
      have ihe' :
          Subtyping.Semantics.Categorical.denote J M he.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M he.rightTyping.toGeneric := ihe
      have ihl' :
          Subtyping.Semantics.Categorical.denote J M hl.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M hl.rightTyping.toGeneric := ihl
      have ihr' :
          Subtyping.Semantics.Categorical.denote J M hr.leftTyping.toGeneric =
            Subtyping.Semantics.Categorical.denote J M hr.rightTyping.toGeneric := ihr
      calc
  ...
  | abort h ih =>
      ...
      calc
        ...
        _ = denote J M (.abort h.rightTyping) := by
          simp only [denote, HasType.toGeneric, Subtyping.Semantics.Categorical.denote]
          exact congrArg (fun q => Subtyping.Semantics.Categorical.abort J M q) ih'
        _ = _ := TypingCoherent.denote_eq _ _
  | iter ha hb iha ihb =>
      have iha' :
          Subtyping.Semantics.Categorical.denote J M ha.leftTyping.toGeneric =
