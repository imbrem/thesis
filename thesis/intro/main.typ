...
)[Reconcile the preceding thesis-introduction drafts and the Neel discussion notes in `notes/neels-recs.typ` with the following verbatim introduction from _The Denotational Semantics of SSA_. Retain the imported version intact until that editorial pass.]
